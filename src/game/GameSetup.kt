...
class GameSetup {
    ...
    fun setupGame(game: Game){
        ...
        val PC = Character("Melkar the Magnificant", "assets//general//conversation frame.png", false, defaultLocation, game)
        game.applyTitleToCharacter(TitleFactory.makeCountTitle("Cookies"), PC)
        game.players.add(PC)

        val NPC = Character("Frip", "assets//portraits//faceman.png", true, defaultLocation, game)
