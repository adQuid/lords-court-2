...
class ActionChooserComponentFactory {
    ...
    fun scenePage(perspective: ShortStateCharacter, action: (Action) -> Unit): Scene {
        ...
        root.add(UtilityComponentFactory.basicList(player.actionsReguarding(UIGlobals.activeGame(), context), action, null, UIGlobals.totalWidth(), UIGlobals.totalHeight() * 0.9), 0,0)
